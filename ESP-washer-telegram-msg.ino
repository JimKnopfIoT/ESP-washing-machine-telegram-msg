/* Arduino script for use with ESP8266 ESP-01 and ADS1115. This scipt let's your washing machine (or whatever) inform you when it finished.
   I use similar script for my tumble dryer.*/
...
if (adc0 > 20000)
   {
     ...
     bot.sendMessage(chatID, "Washer has finished!", ""); // Bot <-> Channel 
     //delay (300);
     delay(1800000); // Wait 30 Minutes when done.
   } else { 
           Serial.print("Washer still tumbling.");
          }
// For testing purpose to find out correct voltage.          
//V0 = (adc0 * 0.1875)/1000;
